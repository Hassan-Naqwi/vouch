                        ...
                        <aside class="border-r h-screen w-1/4">
                            ...
                            <ul class="flex flex-col  gap-2 mt-10">
                                <li><a href="/vouch/controller?action=feed"
                                        class="p-5 pl-10 font-semibold block w-full bg-gray-400 hover:bg-gray-300 ">Feed</a>
                                </li>
                        ...
                        <% ArrayList<PostInfo>posts= (ArrayList<PostInfo>
                                ...
                                <section class="w-3/4 min-h-screen overflow-y-scroll">
                                    <div class="flex flex-col items-center">
                                        <h1 class="font-bold text-3xl py-10">Feed</h1>
                                        <table
                                            ...
                                            <% if(posts.isEmpty()) {%>
                                                <tr>
                                                    <td colspan="5" class="text-center text-red-500 pt-5">No Posts Found
                                                    </td>
                                                </tr>
